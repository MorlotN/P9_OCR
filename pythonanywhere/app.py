...
clicks = pd.read_csv("https://github.com/MorlotN/P9_mycontentnmo/releases/download/First_P9_tag/clicks.csv")
MODEL_PATH = "./recommender.model"
# MODEL_PATH = "https://github.com/MorlotN/P9_mycontentnmo/releases/download/Model_p9/recommender.model"

# MODEL_PATH = "https://github.com/MorlotN/P9_mycontentnmo/releases/tag/Model_p9"
if not os.path.exists(MODEL_PATH):
    os.system("https://github.com/MorlotN/P9_mycontentnmo/releases/download/Model_p9/recommender.model")
...
def get_cf_reco(clicks, userID, csr_item_user, csr_user_item, model_path=None, n_reco=5, train=True):
    ...
    print(f'[INFO] : Recomendations for user {userID}: {recommendations[0]}')
